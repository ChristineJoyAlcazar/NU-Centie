...
const Products = ({ heading, heading1, data }) => {
  return (
    <ProductsContainer>
                ...
                <ProductInfo1>
                  <Link
                    to={{
                      pathname: "/story",
                      state: {
                        title: product.innovator_title,
                        name:
                          product.innovator_fname +
                          " " +
                          product.innovator_lname,
                        description: product.innovator_story,
                        date: dateFormat(product.innovator_date, "mm/dd/yyyy"),
                      },
                    }}
                  >
                    Read More
      ...
      <Viewmore>
        <Link to="/Main">
          <ViewmoreButton to="/Main">
            View More Stories <FaArrowRight />
          </ViewmoreButton>
        </Link>
      </Viewmore>
    </ProductsContainer>
